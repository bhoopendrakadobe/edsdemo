...
## Environments
- Preview: https://main--edsdemo--bhoopendrakadobe.aem.page/
- Live: https://main--edsdemo--bhoopendrakadobe.aem.live/
...
1. Open the `edsdemo` directory in your favourite IDE and start coding :)
